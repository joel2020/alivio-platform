...
export default function MarketingFooter() {
  return <footer className="recruiting-footer"><div className="mkt-container">
    <div className="recruiting-footer-grid"><div><Link to="/" title="Alivio Search Partners home"><AlivioLogo variant="dark" markSize={36} wordSize={26} /></Link><p>Specialized recruiting.<br />Personal attention. Lasting fit.</p><a href="mailto:hello@aliviosearchpartners.com">hello@aliviosearchpartners.com</a><p className="recruiting-footer-caption">Healthcare, technology, and professional search across the U.S.</p></div>
